    ...
    <>
      <div className="bg-white dark:bg-gray-700 w-full rounded-[10px] h-10 px-[15px] shadow-[0_0_8px_#ddd] dark:shadow-[0_0_8px_#777] flex items-center">
        ...
        <input
          ...
          className="w-full h-full outline-none border-none focus:ring-0 placeholder-gray-500 dark:placeholder-gray-400 bg-transparent text-gray-800 dark:text-gray-900"
          value={inputValue ?? ""}
          onChange={(e) => {
