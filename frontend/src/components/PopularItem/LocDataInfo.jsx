    ...
    <>
      ...
      <div className="overflow-x-auto flex -mx-4 px-4 pb-6 md:pb-8">
        {locList.map((data) => (
          <div
            key={data.id}
            className="relative bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md transition-transform duration-300 ease-in-out transform hover:scale-105 cursor-pointer flex-none mr-3 w-40 sm:w-48 md:w-56 lg:w-64 xl:w-72 flex flex-col"
          ...
          >
            ...
            <div className="p-2 md:p-3 flex-grow">
              ...
              {data.animeName ? (
                <p className="text-xs md:text-sm text-gray-500 dark:text-gray-200 whitespace-normal break-words line-clamp-1 md:line-clamp-2">
                  {data.animeName}
                </p>
              ) : (
                <p className="text-xs md:text-sm text-gray-500 dark:text-gray-200 truncate">
                  Associated anime unavailable
                </p>
              )}
            </div>
          </div>
